        ...
        <div className="grid lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-3 mb-6">
              <img src={ticketIcon} alt="Gold Carnival" className="w-12 h-12" />
              <div>
                <h3 className="text-xl font-bold text-primary">GOLD</h3>
                <p className="text-sm text-muted-foreground -mt-1">CARNIVAL</p>
              </div>
            </div>
          ...
          {/* About Gold Carnival */}
          <div>
            <h4 className="text-lg font-semibold text-primary mb-4">ABOUT GOLD CARNIVAL</h4>
          ...
          {/* Legal Info */}
          <div>
            <h4 className="text-lg font-semibold text-primary mb-4">LEGAL INFO</h4>
            <ul className="space-y-3">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-muted-foreground text-sm">support@goldcarnival.com</span>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-start space-x-3">
                ...
                <span className="text-muted-foreground text-sm">
                  Intershore Chambers, Road Town, Tortola,<br />
